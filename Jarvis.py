#Search for python in C and copy path of python and pyhton/scriots in user variables in env variables
#now windows powershell works ok with pip 
#powershell is advanced version of cmd
#try pip install <name of module> in the terminal below
